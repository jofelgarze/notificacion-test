...
public final class SmsNotificationValidator implements ChannelNotificationValidator {

    private final String channel;
    private final String providerName;
    private final NotificationRequestValidator requestValidator;

    public SmsNotificationValidator(String channel, String providerName, NotificationRequestValidator requestValidator) {
    ...
    public void validate(NotificationRequest request) {
        ...
        if (!RecipientFormatUtils.isPhone(request.getRecipient())) {
            throw new NotificationValidationException(
                    "El recipient debe ser un numero telefonico valido para " + providerName);
        }
    }
}
