...
public final class EmailNotificationValidator implements ChannelNotificationValidator {

    private final String channel;
    private final String providerName;
    private final NotificationRequestValidator requestValidator;

    public EmailNotificationValidator(String channel, String providerName, NotificationRequestValidator requestValidator) {
    ...
    public void validate(NotificationRequest request) {
        ...
        if (!RecipientFormatUtils.isEmail(request.getRecipient())) {
            throw new NotificationValidationException(
                    "El recipient debe ser un email valido para " + providerName);
        }
    }
}
